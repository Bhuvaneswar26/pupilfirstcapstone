...
Executing this command will initiate the testing process and provide feedback on the test results, including any failures or errors encountered during testing.
...
![Student Dashboard](public/images/studentdashboard.png)
